...
# Užkrauname ResNet152 modelį, kuris buvo apmokytas ImageNet duomenimis
...
utils.add_column_to_csv('test_images.csv', results, 'ResNet152')

print("*"*50)
print("ResNet152 modelio rezultatai:")
